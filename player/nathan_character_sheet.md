...
- Hand Crossbow: +6 to hit, 1d6+3 Piercing, range 30/120, Light, Loading, Vex
- Dagger: +6 to hit, 1d4+3 Piercing, Finesse, Light, Thrown 20/60
- Sneak Attack: +1d6 once per turn when its requirements are met
...
- Minor Illusion
- Vicious Mockery
- Mage Hand (from `Telekinetic`; does not count against cantrips known)
...
- `player/nathan_equipment.md`
- `player/nathan_al_nassir.md`
- `player/nathan_special_gift.md`
