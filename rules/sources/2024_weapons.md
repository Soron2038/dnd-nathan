# Weapons — provided 2024 table

Status: vom Spieler am 2026-07-21 bereitgestellt; verbindliche Quelle für Weapon damage, properties, mastery, weight und cost.
...
- primary melee: Rapier, 1d8 Piercing, Finesse, Vex, 25 GP
- primary ranged: Hand Crossbow, 1d6 Piercing, Ammunition (30/120; Bolt), Light, Loading, Vex, 75 GP
- concealed reserve: Dagger, 1d4 Piercing, Finesse, Light, Thrown (20/60), Nick, 2 GP
- Weapon Mastery choices: Rapier and Hand Crossbow
- Mastery-property rules for Vex and Nick are confirmed in `rules/sources/2024_weapon_mastery_properties.md`
- Rogue proficiency covers all three selected weapons
- Hand Crossbow is covered because it has the Light property
- Pistol and Musket are not covered by Nathan's current Rogue weapon proficiency
